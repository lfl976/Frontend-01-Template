...
function layout(element) {
  ...
  var items = element.children.filter(e.type === "element");
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    if (itemStyle.flex) {
      ...
      if (itemStyle[mainSize] > style[mainSize]) {
        itemStyle[mainS] = style[mainSize];
      }
  ...
  flexLines.forEach(function (items) {
    ...
    for (var i = 0; i < items.length; i++) {
      ...
      if (align === "flex-start") {
        ...
        itemStyle[crossEnd] =
          itemStyle[crossStart] + crossSign * itemStyle[crossSign];
      }
      ...
      if (align === "center") {
        itemStyle[crossStart] =
          crossBase + crossSign * (lineCrossSize - itemStyle[crossSize]);
        itemStyle[crossEnd] =
